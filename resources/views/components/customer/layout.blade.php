...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand text-secondary" href="/">Icall Footsal</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    @can('is_customer')
                        <li class="nav-item">
                            <a href="/notification" class="btn btn-info">
                                Notifications
                                <span class="badge badge-light rounded-circle" style="background-color: rgb(72, 240, 72);">{{ $notificationCount }}</span>
                            </a>
                        </li>
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link link-success" href="/login-admin">Login Admin</a>
                        </li>
                    @endguest
    ...
    <footer id="sticky-footer" class="d-flex justify-content-around flex-shrink-0 py-4 bg-dark text-white-50 bawahan"
        ...
        <div class="text-white satu" style="margin-left: -100px; width: 350px; text-align: justify;">
            <div class="fs-5 mb-2 fw-semibold">Icall Footsal</div>
        ...
        <div class="text-white contact">
            ...
            <div class="text-white text-opacity-75">Jalan Raya Tapos No. 134</div>
            <div class="text-white text-opacity-75">Kota Depok, Jawa Barat, 16459</div>
            <div class="mt-3 text-white text-opacity-75">footsal@icall.cal.ical</div>
